...
write(unitdmMatrix, 'twitter100000unigram.txt', ncolumns=1, append = FALSE, sep = " ")
rm(unitdm)
rm(unitdmcount)
rm(unitdmMatrix)
...
write(unitdmMatrix, 'twitter100000bigram.txt', ncolumns=1, append = FALSE, sep = " ")
rm(bitdm)
rm(bitdmcount)
rm(bitdmMatrix)
...
write(unitdmMatrix, 'twitter100000trigram.txt', ncolumns=1, append = FALSE, sep = " ")
rm(tritdm)
rm(tritdmcount)
rm(tritdmMatrix)
